...
/***/ function(module, exports, __webpack_require__) {
	...
	var _explorer = __webpack_require__(170);
	...
	var FileSys = function (_React$Component) {
	    _inherits(FileSys, _React$Component);

	    function FileSys(props) {
	        _classCallCheck(this, FileSys);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FileSys).call(this, props));
	    ...
	    _createClass(FileSys, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'section',
	                null,
	                _react2.default.createElement(_explorer2.default, { data: this.state.data, updateData: this.updateData }),
	                _react2.default.createElement(_search2.default, { data: this.state.data })
	            );
	        }
	    }]);
	...
	_reactDom2.default.render(_react2.default.createElement(FileSys, { data: _data2.default }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _filetype = __webpack_require__(172);

	var _filetype2 = _interopRequireDefault(_filetype);

	var _foldertype = __webpack_require__(173);
	...
	var Explorer = function (_React$Component) {
	    ...
	    _createClass(Explorer, [{
	        key: 'generateArr',
	        value: function generateArr(mapa) {
	            var foldersArr = [],
	                filessArr = [],
	            ...
	            return _react2.default.createElement(
	                'section',
	                null,
	                _react2.default.createElement(_foldertype2.default, { data: foldersArr, updateView: this.updateView, sort: sort }),
	                _react2.default.createElement(_filetype2.default, { data: filessArr, sort: sort })
	            );
	        }
	    }, {
	        key: 'updateView',
	        value: function updateView(id, name) {
	            var _this2 = this;
	            ...
	            if (name) {
	                ...
	                mapa = this.state.mapa.filter(function (_, i) {
	                    return i !== _this2.state.mapa.length - 1;
	                });
	                path = this.state.path.filter(function (_, i) {
	                    return i !== _this2.state.path.length - 1;
	                });
	            }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_path2.default, { data: this.state.path, updatePath: this.updatePath }),
	                this.generateArr(this.state.mapa),
	                this.state.mapa.length > 0 ? _react2.default.createElement(ToParent, { updateView: this.updateView }) : ''
	            );
	        }
	    }]);
	...
	var ToParent = function (_React$Component2) {
	    _inherits(ToParent, _React$Component2);

	    function ToParent() {
	        _classCallCheck(this, ToParent);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ToParent).apply(this, arguments));
	    }

	    _createClass(ToParent, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'goUp', onClick: this.props.updateView.bind(this, null, false) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Path = function (_React$Component) {
	    ...
	    _createClass(Path, [{
	        key: "generateArr",
	        value: function generateArr(data) {
	            var arr = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FileType = function (_React$Component) {
	    _inherits(FileType, _React$Component);

	    function FileType() {
	        _classCallCheck(this, FileType);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(FileType).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FolderType = function (_React$Component) {
	    _inherits(FolderType, _React$Component);

	    function FolderType() {
	        _classCallCheck(this, FolderType);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(FolderType).apply(this, arguments));
	    }

	    _createClass(FolderType, [{
	        key: "generateArr",
	        value: function generateArr(data, updateView) {
	            var arr = [];
	            this.props.sort(data);
	            data.map(function (item, index) {
	                arr.push(_react2.default.createElement(
	                    "div",
	                    { className: "item folder", key: index,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = function (_React$Component) {
	    ...
	    _createClass(Search, [{
	        ...
	        key: 'search',
	        value: function search(data, name) {
	            if (data.name == name) {
	                var path = [data.name];
	                return path;
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'search' },
	                _react2.default.createElement('input', { type: 'text', placeholder: 'Search', onChange: this.updateInputVal }),
	                _react2.default.createElement(
	                    'button',
